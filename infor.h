...
static	double *sprite_scale = new double[10]{	0.5,0.5, 0.5, 0.175, 1,
												0.5, 0.5, 0.5, 0.175, 1, };
static	double *sprite_max_move = new double[5]{ 1, 2, 2, 5, 1.0 };
static	double *sprite_max_speed = new double[5]{ 1.0, 1.2, 1.0, 0, 1.0 };
static	int *sprite_sizex = new int[5]{ 25, 25, 25, 55, 10 };
static	int *sprite_sizey = new int[5]{ 25, 25, 25, 55, 10 };
...
static int *sprite_menu_x = new int[3]{-400,0,400};
static int *sprite_menu_y = new int[3]{400, 450, 400};

static double *sprite_menu_position_x = new double[10]{ 0.2,0.2,0.2,1.5,0,
										-0.2, -0.2, -0.2, -1.5, 0};
static double *sprite_menu_position_y = new double[10]{ 0.2, 0.2, 0.2, 1.5, 0,
-0.2, -0.2, -0.2, -1.5, 0};
...
enum PrioGame {background,Sprite,SpriteSleep,SpriteMenu,SpriteDiePar,shade,Menu1,PlayerInfor,Menu2back,Menu2};